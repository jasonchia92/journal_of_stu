(function($){
	...
	$('#header_featured .slide').css({ 'width': $(window).width() , 'height': $(window).height()/2 , 'background-position': '200% 200%' ,
		'background-size':'cover' , 'background-repeat':'no-repeat no-repeat'	});
